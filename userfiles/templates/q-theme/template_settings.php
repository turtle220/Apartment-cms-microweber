...
<style>
    .bootstrap3ns .checkbox label.mw-ui-check, .bootstrap3ns .radio label.mw-ui-check{
        padding-left: 0;
    }
</style>
                ...
                <div class="checkbox">
                    ...
                    <label class="mw-ui-check">
                        <input type="checkbox" class="mw_option_field" id="shopping_cart" name="shopping_cart" data-option-group="mw-template-qtheme" value="true" <?php if ($shopping_cart == 'true') {
                            echo 'checked';
                        } ?> /> <span></span><span><?php _lang("Show shopping cart in header", "templates/qtheme"); ?></span>
                    </label>
                </div>
            </div>
        </div>
                ...
                <div class="checkbox">
                    ...
                    <label class="mw-ui-check">
                        <input type="checkbox" class="mw_option_field" id="footer" name="footer" data-option-group="mw-template-qtheme" value="true" <?php if ($footer == 'true') {
                            echo 'checked';
                        } ?> /> <span></span><span><?php _lang("Turn off Footer for website", "templates/qtheme"); ?></span>
                    </label>
                </div>
            </div>
        </div>
