...
<section class="section-25 <?php print $layout_classes; ?> fx-deactivate edit safe-mode nodrop" field="layout-skin-38-<?php print $params['id'] ?>" rel="module">
    <div class="container">
        <div class="allow-drop">
            ...
            <p><?php print _lang('Our unique value serves as the foundation for our business and our people. They guide us through our culture, our product development and the relationships we share with our partners.', 'templates/qtheme'); ?><br/><br/></p>
        </div>
