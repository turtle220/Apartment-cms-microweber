...
<div class="form-group">
    ...
    <div class="col-lg-10">
        <input id="theme-color-1" class="form-control mw_option_field" data-also-reload="template_settings" name="theme-color-1" data-option-group="mw-template-qtheme" value="<?php print $theme_color_1; ?>"/>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-lg-10">
        <input id="theme-color-2" class="form-control mw_option_field" data-also-reload="template_settings" name="theme-color-2" data-option-group="mw-template-qtheme" value="<?php print $theme_color_2; ?>"/>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-lg-10">
        <input id="theme-color-3" class="form-control mw_option_field" data-also-reload="template_settings" name="theme-color-3" data-option-group="mw-template-qtheme" value="<?php print $theme_color_3; ?>"/>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-lg-10">
        <input id="theme-color-4" class="form-control mw_option_field" data-also-reload="template_settings" name="theme-color-4" data-option-group="mw-template-qtheme" value="<?php print $theme_color_4; ?>"/>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-lg-10">
        <input id="theme-color-5" class="form-control mw_option_field" data-also-reload="template_settings" name="theme-color-5" data-option-group="mw-template-qtheme" value="<?php print $theme_color_5; ?>"/>
    </div>
</div>
