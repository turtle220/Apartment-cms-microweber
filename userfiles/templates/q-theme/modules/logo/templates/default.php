...
<a href="<?php if (!in_live_edit()) {
    ...
    <?php if ($logoimage == false and $text == false): ?>
        ...
        <?php if (is_live_edit()) : ?>
        <span class="logo-text"><span id="fitty-<?php print $params['id'] ?>-1">Q-Theme</span></span>
    <?php endif; ?>
    ...
    <img src="<?php print $logoimage; ?>" alt="" style="padding: 10px 0; height: <?php print $size; ?>; max-height: <?php print $size; ?>;" <?php if (in_live_edit()) {
